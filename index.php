                ...
                <div class="col-12">
                    <form id="regForm" action="amount.php" method="post" enctype="multipart/form">
                        ...
                        <div style="overflow:auto;" class="mb-5 mt-3 pb-5" id="nextprevious">
                            <div style="" class="mx-auto text-center"> <button type="button" class=" my-2 text-dark"
                                    id="prevBtn" onclick="nextPrev(-1)">Previous</button> <button type="button"
                                    class="text-white" id="nextBtn" onclick="nextPrev(1)">Next</button> </div>
                        </div>
                    </form>
                </div>
            </div>
